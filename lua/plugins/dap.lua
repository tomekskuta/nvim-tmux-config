-- Config copied and then adjusted from https://github.com/ecosse3/nvim/blob/dev/lua/plugins/dap.lua
		...
		dependencies = {
			...
			"rcarriga/nvim-dap-ui",
			{
				...
				build = function()
					...
					if parsers and parsers.has_parser and not parsers.has_parser("dap_repl") then
						vim.cmd(":TSInstall dap_repl")
					else
						print("dap_repl parser is not available for installation.")
					end
				end,
			},
		},
